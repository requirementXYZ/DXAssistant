...
OutputDir={#OutputDir}
OutputBaseFilename=DXAssistant-v0.13.1-beta-Setup
Compression=lzma2
...
Source: "{#SourceDir}\DXAssistant-v0.13.1-beta-User-Manual.docx"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#SourceDir}\DXAssistant-v0.13.1-beta-User-Manual.pdf"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\DX Assistant User Manual"; Filename: "{app}\DXAssistant-v0.13.1-beta-User-Manual.pdf"
